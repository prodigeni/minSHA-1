...
80]={0},l=strlen(s),k=0;v t[l+1];memcpy(t,s,l);t[l++]=128;for(i=0;i++<l;){w[k]
+=t[i-1]<<r;((r-=8)>24)?k++,r=24:0;}w[15]=(l-1)*8;for(i=15;i++<80;){r=W(3)^W(8)^
W(14)^W(16);w[i]=R(r,1);}i=0;A(1,(b&c)|((~b)&d),5A827999)A(3,b^c^d,6ED9EBA1)A(5
,(b&c)|(b&d)|(c&d),8F1BBCDC)A(7,b^c^d,CA62C1D6);printf("%08x%08x%08x%08x%08x\n"
,m+a,n+b,o+c,p+d,q+e);}
